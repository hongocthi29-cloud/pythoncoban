...
ttk.Label(frame_info, text="HO NGOC THI").grid(row=0, column=1, sticky="w")

ttk.Label(frame_info, text="Ngày sinh:").grid(row=1, column=0, sticky="w")
ttk.Label(frame_info, text="07/05/2005").grid(row=1, column=1, sticky="w")

ttk.Label(frame_info, text="MSSV:").grid(row=2, column=0, sticky="w")
ttk.Label(frame_info, text="245752021610162").grid(row=2, column=1, sticky="w")

ttk.Label(frame_info, text="Ngành học:").grid(row=3, column=0, sticky="w")
ttk.Label(frame_info, text="TU DONG HOA").grid(row=3, column=1, sticky="w")
